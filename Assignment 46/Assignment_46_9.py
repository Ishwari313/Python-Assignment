...
print(Border)
print("Step 6: Crate and train the model")
...
print(Border)
print("Step 7 : Test the mmodel")
print(Border)

Y_pred = model.predict(X_test)

# Step 8 :Calculate model coefficient

print(Border)
print("Step 8 : Calculate model coefficient")
print(Border)
...
result = pd.DataFrame({'Actual sale':Y_test.value,
