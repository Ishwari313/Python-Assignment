# 7. Predict result for a new student with given input values.
# This demonstrates the practical real-world use of the trained model.
...
# Step 10 : Predict result for a new student

new_student = pd.DataFrame({
    "StudyHours": [2],
    "Attendance": [85],
    "PreviousScore": [66],
    "AssignmentsCompleted": [7],   # example value
    "SleepHours": [10]  
})
